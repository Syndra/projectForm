...
# 30 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 33 "./src/dev_gpio.c" 3 4
              stderr
# 33 "./src/dev_gpio.c"
                    , "Can't export GPIO %d pin: %s\n", gpio, strerror(
# 33 "./src/dev_gpio.c" 3 4
                                                                       (*__errno_location ())
# 33 "./src/dev_gpio.c"
                                                                            ));
...
# 49 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 52 "./src/dev_gpio.c" 3 4
              stderr
# 52 "./src/dev_gpio.c"
                    , "Can't unexport GPIO %d pin: %s\n", gpio, strerror(
# 52 "./src/dev_gpio.c" 3 4
                                                                         (*__errno_location ())
# 52 "./src/dev_gpio.c"
                                                                              ));
...
# 70 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 73 "./src/dev_gpio.c" 3 4
              stderr
# 73 "./src/dev_gpio.c"
                    , "Can't get GPIO %d pin direction: %s\n", gpio, strerror(
# 73 "./src/dev_gpio.c" 3 4
                                                                              (*__errno_location ())
# 73 "./src/dev_gpio.c"
                                                                                   ));
...
# 95 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 98 "./src/dev_gpio.c" 3 4
              stderr
# 98 "./src/dev_gpio.c"
                    , "Can't set GPIO %d pin direction: %s\n", gpio, strerror(
# 98 "./src/dev_gpio.c" 3 4
                                                                              (*__errno_location ())
# 98 "./src/dev_gpio.c"
                                                                                   ));
...
# 123 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 126 "./src/dev_gpio.c" 3 4
              stderr
# 126 "./src/dev_gpio.c"
                    , "Can't get GPIO %d pin value: %s\n", gpio, strerror(
# 126 "./src/dev_gpio.c" 3 4
                                                                          (*__errno_location ())
# 126 "./src/dev_gpio.c"
                                                                               ));
...
# 148 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 151 "./src/dev_gpio.c" 3 4
              stderr
# 151 "./src/dev_gpio.c"
                    , "Can't set GPIO %d pin value: %s\n", gpio, strerror(
# 151 "./src/dev_gpio.c" 3 4
                                                                          (*__errno_location ())
# 151 "./src/dev_gpio.c"
                                                                               ));
...
# 172 "./src/dev_gpio.c"
   ...
   if (fd < 0) {
       fprintf(
# 175 "./src/dev_gpio.c" 3 4
              stderr
# 175 "./src/dev_gpio.c"
                    , "Can't set GPIO %d pin edge: %s\n", gpio, strerror(
# 175 "./src/dev_gpio.c" 3 4
                                                                         (*__errno_location ())
# 175 "./src/dev_gpio.c"
                                                                              ));
...
# 192 "./src/dev_gpio.c"
   ...
   if (fd < 0)
       fprintf(
# 195 "./src/dev_gpio.c" 3 4
              stderr
# 195 "./src/dev_gpio.c"
                    , "Can't open GPIO %d pin: %s\n", gpio, strerror(
# 195 "./src/dev_gpio.c" 3 4
                                                                     (*__errno_location ())
# 195 "./src/dev_gpio.c"
                                                                          ));
...
# 210 "./src/dev_gpio.c"
   ...
   if (ret != 1) {
       fprintf(
# 215 "./src/dev_gpio.c" 3 4
              stderr
# 215 "./src/dev_gpio.c"
                    , "Can't read GPIO %d pin: %s\n", gpio, strerror(
# 215 "./src/dev_gpio.c" 3 4
                                                                     (*__errno_location ())
# 215 "./src/dev_gpio.c"
                                                                          ));
