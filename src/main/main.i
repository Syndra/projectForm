# 1 "./src/main.c"
# 1 "/home/pi/Desktop/gpio_control/src/main//"
# 1 "<built-in>"
# 1 "<command-line>"
...
s32 main(s32 argc, s8 **argv) {
    ...
    if (strncmp(argv[1], "-r", 3) == 0 && argc != 3) {
        print_usage();
        assert(( ( 0x80000000 ) | 0x00000001 ));
    }

    if (strncmp(argv[1], "-w", 3) == 0 && argc != 4) {
        print_usage();
        assert(( ( 0x80000000 ) | 0x00000001 ));
    }
    ...
    if(strncmp(argv[1], "-r", 3) == 0) {
        ...
        if(pin_number > 31 || pin_number < 0) {
            print_usage();
            assert(( ( 0x80000000 ) | 0x00000001 ));
        }
    }else if(strncmp(argv[1], "-w", 3) == 0) {
        pin_number = atoi(argv[2]);
        write_value = atoi(argv[3]);
